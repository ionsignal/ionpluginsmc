 ...
 *
 * @param maxFallDistance The maximum distance a Persona can fall to reach a new block.
 * @param climbHeight The maximum height a Persona can climb in a single step.
