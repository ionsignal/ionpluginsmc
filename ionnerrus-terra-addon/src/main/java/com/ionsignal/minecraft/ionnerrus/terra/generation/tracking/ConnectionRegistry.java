 ...
 * 
 * CRITICAL DEPENDENCY: This implementation relies on Terra's Vector3Int having correct equals() and
 * hashCode() implementations for use as HashMap keys. If Vector3Int uses identity equality instead
 * of value equality, lookups will fail and consumed connections won't be detected.
 * 
 * Key benefits:
